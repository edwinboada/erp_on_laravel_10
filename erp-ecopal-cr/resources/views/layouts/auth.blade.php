...
@php
    ...
    $company_logos=\App\Models\Utility::getValByName('company_logo_light');
...
<head>
    <title>{{-- {{(\App\Models\Utility::getValByName('title_text')) ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'ERPGO')}} --}} - @yield('page-title')</title>
        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6">
                        <p class="">
{{--                             {{(\App\Models\Utility::getValByName('footer_text')) ? \App\Models\Utility::getValByName('footer_text') :  __('Copyright ERPGO') }} {{ date('Y') }} --}}
                        </p>
                    </div>
